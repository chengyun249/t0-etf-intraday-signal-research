...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--raw-dir", type=str, default="./data_t0_2022_2024/raw_1min/freq=1min")
    p.add_argument("--universe-file", type=str, default="./data_t0_2022_2024/config/t0_etf_selected_2022_2024_detail.csv")
    p.add_argument("--out-dir", type=str, default="./data_t0_2022_2024/processed")
